...
float muneca = 0.0f, dedo1 = 0.0f, dedo2 = 0.0f, dedo3 = 0.0f, dedo4 = 0.0f, dedo5 = 0.0f, dedo6 = 0.0f;
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model Palma
		model = glm::translate(modelTemp, glm::vec3(1.0f, 0.0f, 0.0f)); //muñeca
		...
		//Model Dedo 3
		model = glm::translate(modelTemp, glm::vec3(-0.3f, 0.0f, -0.375f));
		...
		//Model Dedo 5
		model = glm::translate(modelTemp, glm::vec3(-0.3f, 0.0f, -0.4f));
