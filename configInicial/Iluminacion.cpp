...
float movelightPos = 0.0f; // LUZ 1
glm::vec3 lightPos2(-1.5f, 0.5f, 1.0f); // LUZ 2
float movelightPos2 = 0.0f; // LUZ 2
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 0.6f, 0.0f, 0.0f);
